...
#######################################################
#Description:
# save input/output of dnn data as npy
# This is a change on dnnclient.py in dictation-kit-v4.4.zip of
#
...
def ff(x0, nth0):
    print ('call ff ', x0.shape)
    f='test1k16_' + str(nth0) + '.npy'
    print (f)
    #print ( x0[0,0], x0[120,0] )
    np.save(f, x0)
